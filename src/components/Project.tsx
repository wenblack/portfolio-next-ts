    ...
    <section className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white p-4 shadow rounded">
          <img src="path/to/project1-image.jpg" alt="Project 1" className="mb-4 rounded" />
        ...
        <div className="bg-white p-4 shadow rounded">
          <img src="path/to/project2-image.jpg" alt="Project 2" className="mb-4 rounded" />
        ...
        <div className="bg-white p-4 shadow rounded">
          <img src="path/to/project3-image.jpg" alt="Project 3" className="mb-4 rounded" />
